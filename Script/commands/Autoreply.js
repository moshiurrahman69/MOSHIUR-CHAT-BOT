...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    ...
    "naruto": "উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ Adil Rahman (NA RU TO)☜\nFacebook: https://www.facebook.com/profile.php?id=61555082783431",
    "admin": "He is Adil Rahman (NA RU TO) তাকে সবাই Cyber Bot Team Saport Admin হিসেবে চিনে😘☺️",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌Naruto 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
